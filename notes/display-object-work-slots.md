...
|---|---|
| `DuelScene_UpdateCardUse` | Reads slots 0 and 1 as display objects, installs objects returned by `func_800291E0` and `Duel_CreateCardEffectOverlay`, modifies their render attributes, flags, scale halves and colour word, and releases both with `func_8004036C`. |
