...
| `0x80041D60` | `DisplayObject_UpdateCommandStream` | `collaborator_match` | `gcc_2_8_1_cc_g0_as_g8_no_split` |
...
| `0x80044D34` | `MemCard_SetIOResultNewCardCB` | `inline_refinement` | `+0x0: 0a80033c != 03000224` |
| `0x80058FB0` | `Model_CopySlotU16Values` | `inline_refinement` | `+0x1: c0180400 != c0100400` |
| `0x80059134` | `Model_InitLightTriplet` | `inline_refinement` | `+0x1: c0180400 != c0100400` |
| `0x80060170` | `Model_RegisterHandlerKey` | `inline_refinement` | `+0x2: 0f80023c != 0f80063c` |
| `0x800601D0` | `Model_FindHandlerKey` | `inline_refinement` | `+0x2: 0f80023c != 0f80033c` |
