...
| `src/game/sound_voice_data.c` | `gcc_2_8_1_g0` | 4 contiguous functions: `func_80048A28` (`0x80048A28`), `0x80048C0C`, `0x80048C70`, `0x80048D08`. #3859 had moved `func_80048A28` and `func_80048F14`, which matched only through pinned registers or inline asm, to `src/candidates/`; `func_80048A28` is back as pure C (#5). |
