...
| `src/game/sd_key_off_voice_slots.c` | `gcc_2_8_1_g0` | 2 contiguous functions: `SD_KeyOffVoiceSlots` (`0x80047EC4`), `0x80047F38`. Kept separate from `src/game/sound_voice_selection.c` because the `func_80047DB0` candidate occupies the exact intervening range from `0x80047DB0` through `0x80047EC4`. |
