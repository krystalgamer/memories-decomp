...
| `src/game/duel_field_display_objects.c` | `gcc_2_8_1_g8_split` | 4 contiguous functions: `0x80023090`, `0x80023144`, `0x8002348C`, `0x800234E4`. #3859 moved `func_80023090` and `func_80023144`, which matched only through pinned registers or inline asm, to `src/candidates/`; both are back as pure C (#5). |
