...
| `src/game/sound_runtime.c` | `gcc_2_8_1_g0` | The contiguous command enqueue (`SD_EnqueueCommand`, `0x80045BE8`) and per-frame volume-ramp update (`SD_UpdateFades`, `0x80045C98`) |
