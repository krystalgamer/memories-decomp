...
| `src/game/mem_card_dialog_step_save.c` | `gcc_2_8_1_g8_split` | 2 contiguous functions: `MemCardDialog_StepSave` (`0x8003EE90`), `MemCardDialog_StepNone` (`0x8003EEC8`). Split out of `src/game/mem_card_dialog_load_save.c` after #3859 moved `MemCardDialog_UpdateSave`, which matched only through pinned registers or inline asm, to `src/candidates/`. |
