...
| `0x8009B394..0x8009B39A`, `0x8009B3A4..0x8009B3A6` | raw pad globals | RESOLVED by matching `Input_UpdatePads`: 394/396 are repeat masks, 398/39A newly-pressed masks, and 3A4/3A6 held masks for pads 1/2 respectively. | Name the six-global family together in a dedicated pass. |
