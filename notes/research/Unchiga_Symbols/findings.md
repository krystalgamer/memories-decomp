...
| F143 | WA_MRG 0xF35000 | The 25 dialog portraits: 2432 bytes each (48x48 8bpp then a 64-entry CLUT), at 0xF35000 + 2432*(n-1), disc LBA 17888..17917. Selected by text control `F6 (0x40+n) 00`, which `Text_HandleDisplayEffectCommand` turns into a 0x4C-byte face-box record in `D_800EB010` (index >= 0x41 means portrait). | `gText_aDialogPortraits` | PENDING |
