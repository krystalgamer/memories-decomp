...
| `0x80082840` | `SetSemiTrans` | Applied from the unique 40-byte Psy-Q 4.6 `LIBGPU.LIB/P10.OBJ` signature; matching display-object renderers `DisplayObject_RenderSpriteList` and `func_800408D0` use the canonical `libgpu.h` declaration for their clipped scratchpad quads. |
