...
`func_80030FD0.c` returns through `longjmp(..., 2)`. `Main_Init` is matching
C in `src/game/main_init.c`; `Main_RunGameOver` remains a candidate in
`src/candidates/func_8002D730.c`. `func_80030FD0.c` is the other matching
