...
`func_80030FD0.c` returns through `longjmp(..., 2)`. `Main_Init` matches from
`src/game/main_init.c`, while `Main_RunGameOver` matches from
`src/game/main_run_game_over.c`; `func_80030FD0.c` is the other matching user.
The imported `longjmp`
