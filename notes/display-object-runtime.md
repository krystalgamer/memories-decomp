...
| `0x08000000` | When **clear**, selects the alternate size/offset path in `func_80040588`; also gates a projection path in `func_80041F90` (`src/game/display_object_projection.c`), and is copied into the clip state as `c->flag` | both renderers |
