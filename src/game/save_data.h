 ...
 * (src/overlays/main_menu/trade_inventory.c:26, `+ slot * 0x1000`) and
 * MainMenu_UpdateTradeScreen (src/overlays/main_menu/trade_update.c:93 and
 * :134, through that unit's 16-byte Block16 view, cast at the use). The
