 ...
 * model_slot_state_updates.c drive. func_8005A468 sets the playback speed of
 * every part's GsSEQ in one slot; func_8005A4C4 takes the slot record itself
 * rather than its index, which is why the two do not share a parameter
 * shape. */
