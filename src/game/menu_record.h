 ...
 *
 * field_30 is the signed marker the walkers test for `>= 0`; field_34 is the
 * halfword func_8002EB78 seeds with 0xD8 and DuelEffect_MarkObjectIfActive
 * later ORs bit 1 into.
 */
typedef struct {
    s32 grid[4][3];
    s8 field_30;
