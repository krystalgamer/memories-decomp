 ...
 * pass &D_800F2848, so ViewState's pad_10 and its field_1C through field_2C
 * are that GsRVIEW2's members. See the note in the PR; view_state.h is not
 * changed here because #2689 is already editing it. */
