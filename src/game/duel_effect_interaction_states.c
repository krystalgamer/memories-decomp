...
extern signed char D_8009B32C;extern unsigned short gInput_wPad1Held[],gInput_wPad1Pressed[];extern unsigned char*Dialog_OpenChoice(unsigned char*);extern void SD_SEPlayFull(int);
