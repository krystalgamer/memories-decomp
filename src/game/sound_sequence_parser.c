...
/* The sequence parser prefix: the fixed-width big-endian readers and the
   header reader that uses them to set up track and tempo.

   SD_ReadSequenceHeader was recorded at gcc_2_8_1_cc_g8_as_g0_split against
   gcc_2_8_1_g0 for the surrounding functions; it compiles to an identical
   object at gcc_2_8_1_g0, as its own history note below says it was first
   matched with -G0. */
