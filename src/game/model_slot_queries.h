 ...
 * the same halfword.
 *
 * Model_GetSlotAnimationSpeed, func_80058E94 and func_80058EC0 have no caller
 * yet -- none in C and none in the generated assembly. They are declared here
 * anyway so that whoever decompiles their callers finds a signature instead
 * of inventing one. */
