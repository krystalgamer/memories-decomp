...
void SaveData_RequestWrite(void){Util_CopyWords(D_801D3200,gDuel_awPlayerDeck,0x680);func_8003D03C(D_801D3200-0x200);func_8003F758(D_801D3200,0xD00,D_80010384,2);}
