...
typedef struct DisplayObject {
    ...
    /* Read two ways, like 0x44, and for the same reason: 0x4C is the fifth of
       ...
       src/candidates/duel_init_scene.c and func_8002ABB4.c each store a
    ...
    /* The last unnamed word of the tail, and read as incompatibly as 0x4C
       ...
       src/candidates/duel_init_scene.c stores a pointer to another display
    ...
    /* Reached as halves as well, by the same witness 0x38 describes and
       ...
       by name spell it .word: src/candidates/duel_init_scene.c, which stores
