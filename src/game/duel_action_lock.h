 ...
 * subtract DUEL_DIRECT_DAMAGE_FIRST_CARD_ID from it, and
 * DuelEffect_StartRitual
 ...
 * all gp-relative; the one lhu of D_8009B1D2 is in DuelEffect_ApplyRitual,
 * now matching C. The u16 spellings were only in the writer, where a store shows
 * no sign. DuelEffect_ApplyTerrain reads the low byte of D_8009B1D2 through an
