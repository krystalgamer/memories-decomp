...
/* Entries 1 through 12 of the secondary text-command table D_80090EAC,
   ...
   operands from the channel's live stream. Entry 0, func_80037DA4, precedes
   this run and remains a candidate. Entry 13, Text_StartCampaignDuel, is next
   in both the table and the image, but it only builds at gcc_2_8_1_g0 and
   stays its own unit.

   The former sources were recorded at gcc_2_8_1_g8_split, gcc_2_8_1_g8,
   gcc_2_8_1_g0 and gcc_2_8_1_g0_split, and every member compiles to an
   identical object at gcc_2_8_1_g8_split. Bounded below by the primary
   handlers Text_ExtendGlyphCode and Text_SetStateFromStream in
