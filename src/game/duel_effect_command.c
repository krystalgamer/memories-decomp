...
#if !defined(VERSION_JAPAN) || defined(VERSION_JAPAN_FUNC_80038094)
...
#if !defined(VERSION_JAPAN) || defined(VERSION_JAPAN_FUNC_80038388)
...
#if !defined(VERSION_JAPAN) || defined(VERSION_JAPAN_DUEL_EFFECT_SET_FLAG_1000)
