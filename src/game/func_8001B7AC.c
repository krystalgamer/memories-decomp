...
void func_8001B7AC(DuelHandStackState *arg)
{
 ...
 DisplayObject_SelectOrderingTable1((DisplayObject *)child);DisplayObject_SetDepthOffset((u8 *)child,(s8)(slot->object[0x16]+1));slot->child=(u8*)child;object->count++;slot->active_09=object->count;SD_SEPlayFull(0x2F);
}
