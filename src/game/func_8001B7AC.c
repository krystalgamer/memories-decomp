...
void func_8001B7AC(Object*arg)
{
 ...
 ((Spawned*)slot->object)->y-=4;child=func_800400AC(func_8004002C(),1);func_80040510((DisplayObjectConfigView*)child,((Spawned*)slot->object)->x,((Spawned*)slot->object)->y,0x10,0x10,object->count<<4,0xB8,0xB,0x250,0xFC);
