 ...
 *
 * D_8009B0D1 is cleared during startup and when starting a new campaign.
 * Startup keeps its volatile small-data view; the menu transition requires
 * an absolute .data store.
 *
