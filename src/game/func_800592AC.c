...
void func_800592AC(s32 arg0, s32 arg1, Obj *arg2) {
    ...
    arg2->f0 = 0;
    arg2->f44 = (s16)(MODEL_ANGLE_FULL_TURN -
        slot->field_D18->field_44);
    arg2->f46 = (s16)(MODEL_ANGLE_FULL_TURN -
        slot->field_D18->field_46);
    arg2->f48 = (s16)(MODEL_ANGLE_FULL_TURN -
        slot->field_D18->field_48);
