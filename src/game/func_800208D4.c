...
void func_800208D4(void){if(!(D_8009B23A&DUEL_SCENE_FLAG_INITIALIZED)){D_8009B23A|=DUEL_SCENE_FLAG_INITIALIZED;func_80022D94(0x30,0x258,0x100,D_8009B1D5?0x400:0xC00,0);D_8009B162=0x10;}
