 ...
 * slot in order once per frame, and Main_ResetFrameServices clears all four. The size is
 ...
 * Main_ResetFrameServices clears alongside them; only it and main_services.c use it. */
...
/* The pump itself, and the call that empties the registry. Main_RunFrameServices
   walks the four slots once per frame; Main_ResetFrameServices clears all four. Both
