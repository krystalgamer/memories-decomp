...
void func_8001D3C4(DisplayObject*o)
{
 ...
 func_8004318C((DisplayObjectPosition *)o,*(s16*)&o->position.h.field_28,*(s16*)&o->position.h.field_2A,o->field_60);o->field_60+=TRIG_ANGLE_HALF_TURN/o->field_2C.h.field_2E;
