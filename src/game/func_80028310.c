...
extern unsigned short D_8009B244;extern unsigned char D_8009B248,D_8009B254;extern int func_800282E8(void),Input_IsPad1ConfirmPressed(void);extern unsigned char*TextBox_Create(int,int,int,int,int,int),*Dialog_OpenChoice(void*);extern void func_80039794(void),SD_SEPlayFull(int),TextBox_Destroy(void*);
