...
extern State D_800EAE88;extern int Duel_CollectFieldCardsByType(Entry**,int,int),func_80026C0C(int),rand(void);
int func_8002712C(void)
{
 Entry*list[6];int count=Duel_CollectFieldCardsByType(list,0,20);
