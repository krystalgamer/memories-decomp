 ...
 * view for this translation unit; earlier callers retain their no-argument
 * view, while the shared definition ignores the parameter. No dead expression,
 * register pin, inline assembly or new profile is needed.
 *
