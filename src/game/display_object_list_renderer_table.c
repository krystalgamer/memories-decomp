 ...
 *
 * This is the one table in this group with a real bound.
 * DisplayObject_RenderLists walks it from
 * `DISPLAY_OBJECT_LIST_COUNT - 1` down to zero, that constant is seven in
 * display_object_layout.h, and there are seven entries. It agrees
