 ...
 * as a signed byte. func_80024200 takes the .data arm below for its absolute
 * load; the former `s8 [9]` spelling was only a placement device, not a
 * nine-element storage claim.
 */
