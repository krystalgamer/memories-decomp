 ...
 * the packed id it returns. model_cleanup.c is the only outside consumer and
 * takes its address as an s32 (*)(s32) callback rather than calling it, so
 * this declaration has to keep that exact shape. */
