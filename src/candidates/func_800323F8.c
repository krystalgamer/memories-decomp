...
void func_800323F8(u8 *arg0, u8 *arg1, s32 arg2, s32 arg3)
{
    ...
    *(s32 *)(p + 0x6344) = arg2;
    ...
    DisplayObject_ConfigureSpriteAtPosition(o, 0, 0, 0, 4, 0, 0xC, 0x208);
    o2 = DisplayObject_AcquireSlot(DisplayObject_FindFreeGeneralSlot(), 6);
    o2[0x67] = 0;
    *(s32 *)(o2 + 0x30) = *(s32 *)(o + 0x30);
    *(s32 *)(o2 + 0x4C) = (s32)func_80031874;
    o = DisplayObject_AcquireSlot(DisplayObject_FindFreeGeneralSlot(), 2);
    DisplayObject_ConfigureSpriteAtPosition(o, 0x140, 0, 0, 4, 1, 0xC, 0x208);
    o2 = DisplayObject_AcquireSlot(DisplayObject_FindFreeGeneralSlot(), 6);
    o2[0x67] = 1;
    *(s32 *)(o2 + 0x30) = *(s32 *)(o + 0x30);
    *(s32 *)(o2 + 0x4C) = (s32)func_80031874;
    *(s16 *)(p + 0x633E) = 2;
    o = DisplayObject_AcquireSlot(DisplayObject_FindFreeGeneralSlot(), 2);
    DisplayObject_ConfigureSpriteAtPosition(o, 0x136, 0x29, 0, 4, 0xC, 0xC, 0x208);
    *(u16 *)(o + 8) |= 0x20;
    DisplayObject_SetDepthOffset((DisplayObject *)o, 8);
    *(u8 **)(p + 0x2D3C) = o;
    o = DisplayObject_AcquireSlot(DisplayObject_FindFreeGeneralSlot(), 2);
    DisplayObject_ConfigureSpriteAtPosition(o, 0x26A, 0x29, 0, 4, 0xC, 0xC, 0x208);
    *(u16 *)(o + 8) |= 0x20;
    DisplayObject_SetDepthOffset((DisplayObject *)o, 8);
    *(u8 **)(p + 0x5A88) = o;
    o = DisplayObject_AcquireSlot(DisplayObject_FindFreeGeneralSlot(), 2);
    DisplayObject_ConfigureSpriteAtPosition(o, 0, 0x2A, 0, 4, 2, 0xC, 0x208);
    *(u16 *)(o + 8) |= 0x20;
    DisplayObject_SetDepthOffset((DisplayObject *)o, 0xA);
    *(u8 **)(p + 0x2D38) = o;
    o = DisplayObject_AcquireSlot(DisplayObject_FindFreeGeneralSlot(), 2);
    DisplayObject_ConfigureSpriteAtPosition(o, 0x148, 0x2A, 0, 4, 3, 0xC, 0x218);
    *(u16 *)(o + 8) |= 0x20;
    DisplayObject_SetDepthOffset((DisplayObject *)o, 0xA);
    *(u8 **)(p + 0x5A84) = o;
    o = DisplayObject_AcquireSlot(DisplayObject_FindFreeGeneralSlot(), 2);
    DisplayObject_ConfigureSpriteAtPosition(o, 0, 0, 0, 4, 9, 0xC, 0x208);
    *(u16 *)(o + 8) |= 0x20;
    DisplayObject_SetDepthOffset((DisplayObject *)o, 0xA);
    o = DisplayObject_AcquireSlot(DisplayObject_FindFreeGeneralSlot(), 2);
    DisplayObject_ConfigureSpriteAtPosition(o, 0x140, 0, 0, 4, 0xA, 0xC, 0x208);
    *(u16 *)(o + 8) |= 0x20;
    DisplayObject_SetDepthOffset((DisplayObject *)o, 0xA);
    o = DisplayObject_AcquireSlot(DisplayObject_FindFreeGeneralSlot(), 2);
    DisplayObject_ConfigureSpriteAtPosition(o, 0, 0, 0, 4, 0xB, 0xC, 0x208);
    *(u16 *)(o + 8) |= 0x20;
    DisplayObject_SetDepthOffset((DisplayObject *)o, -4);
    o = DisplayObject_AcquireSlot(DisplayObject_FindFreeGeneralSlot(), 2);
    DisplayObject_ConfigureSpriteAtPosition(o, 0x140, 0, 0, 4, 0xB, 0xC, 0x208);
    *(u16 *)(o + 8) |= 0x20;
    DisplayObject_SetDepthOffset((DisplayObject *)o, -4);
    o = DisplayObject_AcquireSlot(DisplayObject_FindFreeGeneralSlot(), 2);
    DisplayObject_ConfigureSpriteAtPosition(o, 0x140, 0, 3, 0, 3, 0xB, 0x2F8);
    DisplayObject_SetDepthOffset((DisplayObject *)o, -4);
    BuildDeck_RefreshCountDisplay((BuildDeckTransitionState *)p);
}
