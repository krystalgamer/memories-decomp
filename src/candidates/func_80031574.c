 ...
 * pinning 6 variables to hard registers and 2 inline asm statements, so it is kept here as a candidate
 * rather than counted as a decompilation. It was src/game/duel_card_stat_display.c.
 */
#include "../types.h"
...
#include "../game/duel_card_stat_display.h"
