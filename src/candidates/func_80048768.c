/* Reclassified from matching_c (#3859). This was src/game/func_80048768.c.
 * It is byte-exact under gcc_2_8_1_g0 only with 10 variables pinned to hard
 * registers; the mixed-G gcc_2_8_1_cc_g0_as_g8 it was first matched at
 * turned out to be inert. Without the pins it is 112 instructions against
 * the target's 110, opcode distance 2. The source below is the match,
