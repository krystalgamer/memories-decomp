...
PAIRS = [
    ...
    ("src/candidates/func_80040DD8.c", "func_80042188", '#include "../game/display_object_list_renderers.h"'),
    ("src/game/func_80041068.c", "func_80042188", '#include "display_object_list_renderers.h"'),
]
