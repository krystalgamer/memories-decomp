...
| Metric | Current |
|---|---:|
| Matching C functions | **1,046 / 1,195 (87.53%)** |
| Matching C bytes | **199,756 (`0x30C4C`) / 396,196 (`0x60BA4`) (50.42%)** |
| Remaining compiler-generated game assembly | 86 functions, 150,204 (`0x24ABC`) |
