...
| Metric | Current |
|---|---:|
| Exact matching C functions | **676** |
| Exact matching C bytes | **153,816 (`0x258D8`)** |
| Resident text represented by matching C | **153,816 (`0x258D8`) / 515,264 (`0x7DCC0`) (29.85%)** |
| Resident text using exact assembly/binary fallback | 361,448 (`0x583E8`) |
