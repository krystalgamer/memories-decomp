...
| Metric | Current |
|---|---:|
| Matching C functions | **940 / 1,196 (78.60%)** |
| Matching C bytes | **146,252 (`0x23B4C`) / 396,212 (`0x60BB4`) (36.91%)** |
| Remaining compiler-generated game assembly | 193 functions, 203,724 (`0x31BCC`) |
