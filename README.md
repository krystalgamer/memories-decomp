...
| Metric | Current |
|---|---:|
| Matching C functions | **888 / 1,196 (74.25%)** |
| Matching C bytes | **120,312 (`0x1D5F8`) / 396,212 (`0x60BB4`) (30.37%)** |
| Remaining compiler-generated game assembly | 245 functions, 229,664 (`0x38120`) |
