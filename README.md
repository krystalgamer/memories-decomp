...
| Metric | Current |
|---|---:|
| Matching C functions | **1,071 / 1,195 (89.62%)** |
| Matching C bytes | **219,756 (`0x35A6C`) / 396,196 (`0x60BA4`) (55.47%)** |
| Remaining compiler-generated game assembly | 61 functions, 130,204 (`0x1FC9C`) |
