...
| Metric | Current |
|---|---:|
| Exact matching C functions | **552** |
| Exact matching C bytes | **81,392 (`0x13DF0`)** |
| Resident text represented by matching C | **81,392 (`0x13DF0`) / 515,264 (`0x7DCC0`) (15.80%)** |
| Resident text using exact assembly/binary fallback | 433,872 (`0x69ED0`) |
