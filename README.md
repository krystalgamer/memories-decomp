...
| Metric | Current |
|---|---:|
| Exact matching C functions | **468** |
| Exact matching C bytes | **63,028 (`0xF634`)** |
| Resident text represented by matching C | **63,028 (`0xF634`) / 515,264 (`0x7DCC0`) (12.23%)** |
| Resident text using exact assembly/binary fallback | 452,236 (`0x6E68C`) |
