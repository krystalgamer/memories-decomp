...
| Metric | Current |
|---|---:|
| Matching C functions | **996 / 1,195 (83.35%)** |
| Matching C bytes | **172,348 (`0x2A13C`) / 396,196 (`0x60BA4`) (43.50%)** |
| Remaining compiler-generated game assembly | 136 functions, 177,612 (`0x2B5CC`) |
