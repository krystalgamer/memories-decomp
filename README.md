...
| Metric | Current |
|---|---:|
| Matching C functions | **882 / 1,196 (73.75%)** |
| Matching C bytes | **118,204 (`0x1CDBC`) / 396,212 (`0x60BB4`) (29.83%)** |
| Remaining compiler-generated game assembly | 251 functions, 231,772 (`0x3895C`) |
