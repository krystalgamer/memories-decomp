...
| Metric | Current |
|---|---:|
| Matching C functions | **1,055 / 1,195 (88.28%)** |
| Matching C bytes | **206,524 (`0x326BC`) / 396,196 (`0x60BA4`) (52.13%)** |
| Remaining compiler-generated game assembly | 77 functions, 143,436 (`0x2304C`) |
