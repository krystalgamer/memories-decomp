...
| Metric | Current |
|---|---:|
| Matching C functions | **795 / 1,196 (66.47%)** |
| Matching C bytes | **98,616 (`0x18138`) / 396,212 (`0x60BB4`) (24.89%)** |
| Remaining compiler-generated game assembly | 338 functions, 251,360 (`0x3D5E0`) |
