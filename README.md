...
| Metric | Current |
|---|---:|
| Exact matching C functions | **279** |
| Exact matching C bytes | **40,904 (`0x9FC8`)** |
| Resident text represented by matching C | **40,904 (`0x9FC8`) / 515,264 (`0x7DCC0`) (7.94%)** |
| Resident text using exact assembly/binary fallback | 474,360 (`0x73CF8`) |
