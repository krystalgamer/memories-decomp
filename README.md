...
| Metric | Current |
|---|---:|
| Exact matching C functions | **69** |
| Exact matching C bytes | **7,468 (`0x1D2C`)** |
| Resident text represented by matching C | **7,468 (`0x1D2C`) / 515,264 (`0x7DCC0`) (1.45%)** |
| Resident text using exact assembly/binary fallback | 507,796 (`0x7BF94`) |
