...
| Metric | Current |
|---|---:|
| Matching C functions | **799 / 1,196 (66.81%)** |
| Matching C bytes | **99,252 (`0x183B4`) / 396,212 (`0x60BB4`) (25.05%)** |
| Remaining compiler-generated game assembly | 334 functions, 250,724 (`0x3D364`) |
