...
| Metric | Current |
|---|---:|
| Matching C functions | **868 / 1,196 (72.58%)** |
| Matching C bytes | **113,948 (`0x1BD1C`) / 396,212 (`0x60BB4`) (28.76%)** |
| Remaining compiler-generated game assembly | 265 functions, 236,028 (`0x399FC`) |
