...
| Metric | Current |
|---|---:|
| Matching C functions | **1,073 / 1,195 (89.79%)** |
| Matching C bytes | **220,688 (`0x35E10`) / 396,196 (`0x60BA4`) (55.70%)** |
| Remaining compiler-generated game assembly | 59 functions, 129,272 (`0x1F8F8`) |
