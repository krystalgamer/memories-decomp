...
| Metric | Current |
|---|---:|
| Matching C functions | **1,038 / 1,195 (86.86%)** |
| Matching C bytes | **194,040 (`0x2F5F8`) / 396,196 (`0x60BA4`) (48.98%)** |
| Remaining compiler-generated game assembly | 94 functions, 155,920 (`0x26110`) |
