...
| Metric | Current |
|---|---:|
| Matching C functions | **796 / 1,196 (66.56%)** |
| Matching C bytes | **98,764 (`0x181CC`) / 396,212 (`0x60BB4`) (24.93%)** |
| Remaining compiler-generated game assembly | 337 functions, 251,212 (`0x3D54C`) |
