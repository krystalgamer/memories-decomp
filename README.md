...
| Metric | Current |
|---|---:|
| Exact matching C functions | **544** |
| Exact matching C bytes | **80,764 (`0x13B7C`)** |
| Resident text represented by matching C | **80,764 (`0x13B7C`) / 515,264 (`0x7DCC0`) (15.67%)** |
| Resident text using exact assembly/binary fallback | 434,500 (`0x6A144`) |
