...
| Metric | Current |
|---|---:|
| Matching C functions | **818 / 1,196 (68.39%)** |
| Matching C bytes | **101,884 (`0x18DFC`) / 396,212 (`0x60BB4`) (25.71%)** |
| Remaining compiler-generated game assembly | 315 functions, 248,092 (`0x3C91C`) |
