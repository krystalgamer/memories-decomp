...
| Metric | Current |
|---|---:|
| Exact matching C functions | **281** |
| Exact matching C bytes | **40,984 (`0xA018`)** |
| Resident text represented by matching C | **40,984 (`0xA018`) / 515,264 (`0x7DCC0`) (7.95%)** |
| Resident text using exact assembly/binary fallback | 474,280 (`0x73CA8`) |
