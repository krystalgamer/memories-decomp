...
| Metric | Current |
|---|---:|
| Matching C functions | **1,067 / 1,195 (89.29%)** |
| Matching C bytes | **217,520 (`0x351B0`) / 396,196 (`0x60BA4`) (54.90%)** |
| Remaining compiler-generated game assembly | 65 functions, 132,440 (`0x20558`) |
