...
| Metric | Current |
|---|---:|
| Matching C functions | **1,074 / 1,195 (89.87%)** |
| Matching C bytes | **221,528 (`0x36158`) / 396,196 (`0x60BA4`) (55.91%)** |
| Remaining compiler-generated game assembly | 58 functions, 128,432 (`0x1F5B0`) |
