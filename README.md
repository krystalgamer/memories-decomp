...
| Metric | Current |
|---|---:|
| Exact matching C functions | **167** |
| Exact matching C bytes | **22,444 (`0x57AC`)** |
| Resident text represented by matching C | **22,444 (`0x57AC`) / 515,264 (`0x7DCC0`) (4.36%)** |
| Resident text using exact assembly/binary fallback | 492,820 (`0x78514`) |
