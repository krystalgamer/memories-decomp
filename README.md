...
| Metric | Current |
|---|---:|
| Exact matching C functions | **319** |
| Exact matching C bytes | **45,636 (`0xB244`)** |
| Resident text represented by matching C | **45,636 (`0xB244`) / 515,264 (`0x7DCC0`) (8.86%)** |
| Resident text using exact assembly/binary fallback | 469,628 (`0x72A7C`) |
