...
| Metric | Current |
|---|---:|
| Matching C functions | **811 / 1,196 (67.81%)** |
| Matching C bytes | **101,056 (`0x18AC0`) / 396,212 (`0x60BB4`) (25.51%)** |
| Remaining compiler-generated game assembly | 322 functions, 248,920 (`0x3CC58`) |
