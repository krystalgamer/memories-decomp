...
| Metric | Current |
|---|---:|
| Matching C functions | **986 / 1,195 (82.51%)** |
| Matching C bytes | **167,452 (`0x28E1C`) / 396,196 (`0x60BA4`) (42.26%)** |
| Remaining compiler-generated game assembly | 146 functions, 182,508 (`0x2C8EC`) |
