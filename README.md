...
| Metric | Current |
|---|---:|
| Matching C functions | **850 / 1,196 (71.07%)** |
| Matching C bytes | **108,284 (`0x1A6FC`) / 396,212 (`0x60BB4`) (27.33%)** |
| Remaining compiler-generated game assembly | 283 functions, 241,692 (`0x3B01C`) |
