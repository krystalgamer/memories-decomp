...
| Metric | Current |
|---|---:|
| Matching C functions | **1,033 / 1,195 (86.44%)** |
| Matching C bytes | **191,212 (`0x2EAEC`) / 396,196 (`0x60BA4`) (48.26%)** |
| Remaining compiler-generated game assembly | 99 functions, 158,748 (`0x26C1C`) |
