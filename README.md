...
| Metric | Current |
|---|---:|
| Matching C functions | **821 / 1,196 (68.65%)** |
| Matching C bytes | **102,316 (`0x18FAC`) / 396,212 (`0x60BB4`) (25.82%)** |
| Remaining compiler-generated game assembly | 312 functions, 247,660 (`0x3C76C`) |
