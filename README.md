...
| Metric | Current |
|---|---:|
| Matching C functions | **908 / 1,196 (75.92%)** |
| Matching C bytes | **129,064 (`0x1F828`) / 396,212 (`0x60BB4`) (32.57%)** |
| Remaining compiler-generated game assembly | 225 functions, 220,912 (`0x35EF0`) |
