...
| Metric | Current |
|---|---:|
| Exact matching C functions | **241** |
| Exact matching C bytes | **38,160 (`0x9510`)** |
| Resident text represented by matching C | **38,160 (`0x9510`) / 515,264 (`0x7DCC0`) (7.41%)** |
| Resident text using exact assembly/binary fallback | 477,104 (`0x747B0`) |
