...
| Metric | Current |
|---|---:|
| Matching C functions | **831 / 1,196 (69.48%)** |
| Matching C bytes | **104,128 (`0x196C0`) / 396,212 (`0x60BB4`) (26.28%)** |
| Remaining compiler-generated game assembly | 302 functions, 245,848 (`0x3C058`) |
