...
| Metric | Current |
|---|---:|
| Matching C functions | **1,075 / 1,195 (89.96%)** |
| Matching C bytes | **222,220 (`0x3640C`) / 396,196 (`0x60BA4`) (56.09%)** |
| Remaining compiler-generated game assembly | 57 functions, 127,740 (`0x1F2FC`) |
