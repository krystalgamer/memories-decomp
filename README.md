...
| Metric | Current |
|---|---:|
| Exact matching C functions | **546** |
| Exact matching C bytes | **80,900 (`0x13C04`)** |
| Resident text represented by matching C | **80,900 (`0x13C04`) / 515,264 (`0x7DCC0`) (15.70%)** |
| Resident text using exact assembly/binary fallback | 434,364 (`0x6A0BC`) |
