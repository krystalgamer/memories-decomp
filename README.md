...
| Metric | Current |
|---|---:|
| Matching C functions | **826 / 1,196 (69.06%)** |
| Matching C bytes | **103,228 (`0x1933C`) / 396,212 (`0x60BB4`) (26.05%)** |
| Remaining compiler-generated game assembly | 307 functions, 246,748 (`0x3C3DC`) |
