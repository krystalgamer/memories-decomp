...
| Metric | Current |
|---|---:|
| Matching C functions | **794 / 1,196 (66.39%)** |
| Matching C bytes | **98,468 (`0x180A4`) / 396,212 (`0x60BB4`) (24.85%)** |
| Remaining compiler-generated game assembly | 339 functions, 251,508 (`0x3D674`) |
