...
| Metric | Current |
|---|---:|
| Matching C functions | **798 / 1,196 (66.72%)** |
| Matching C bytes | **99,104 (`0x18320`) / 396,212 (`0x60BB4`) (25.01%)** |
| Remaining compiler-generated game assembly | 335 functions, 250,872 (`0x3D3F8`) |
