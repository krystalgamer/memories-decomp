...
| Metric | Current |
|---|---:|
| Exact matching C functions | **32** |
| Exact matching C bytes | **3,068 (`0xBFC`)** |
| Resident text represented by matching C | **3,068 (`0xBFC`) / 515,264 (`0x7DCC0`) (0.60%)** |
| Resident text using exact assembly/binary fallback | 512,196 (`0x7D0C4`) |
