...
| Metric | Current |
|---|---:|
| Exact matching C functions | **750** |
| Exact matching C bytes | **185,660 (`0x2D53C`)** |
| Resident text represented by matching C | **185,660 (`0x2D53C`) / 515,264 (`0x7DCC0`) (36.03%)** |
| Resident text using exact assembly/binary fallback | 329,604 (`0x50784`) |
