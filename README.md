...
| Metric | Current |
|---|---:|
| Matching C functions | **1,072 / 1,195 (89.71%)** |
| Matching C bytes | **220,196 (`0x35C24`) / 396,196 (`0x60BA4`) (55.58%)** |
| Remaining compiler-generated game assembly | 60 functions, 129,764 (`0x1FAE4`) |
