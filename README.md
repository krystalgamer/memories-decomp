...
| Metric | Current |
|---|---:|
| Matching C functions | **1,041 / 1,195 (87.11%)** |
| Matching C bytes | **195,740 (`0x2FC9C`) / 396,196 (`0x60BA4`) (49.40%)** |
| Remaining compiler-generated game assembly | 91 functions, 154,220 (`0x25A6C`) |
