...
| Metric | Current |
|---|---:|
| Matching C functions | **824 / 1,196 (68.90%)** |
| Matching C bytes | **102,852 (`0x191C4`) / 396,212 (`0x60BB4`) (25.96%)** |
| Remaining compiler-generated game assembly | 309 functions, 247,124 (`0x3C554`) |
