...
| Metric | Current |
|---|---:|
| Exact matching C functions | **747** |
| Exact matching C bytes | **179,192 (`0x2BBF8`)** |
| Resident text represented by matching C | **179,192 (`0x2BBF8`) / 515,264 (`0x7DCC0`) (34.78%)** |
| Resident text using exact assembly/binary fallback | 336,072 (`0x520C8`) |
